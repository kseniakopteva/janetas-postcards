<x-modal name="add-images" focusable :show="$show">
    <div class="p-6">
        ...
        <form action="{{ route('image.store') }}" method="POST" enctype="multipart/form-data" id="addImagesForm">
            @csrf
 ...
 focus:bg-gray-50 active:bg-gray-50 active:border-rose-300 focus:border-rose-300
 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 transition ease-in-out duration-150
                "
